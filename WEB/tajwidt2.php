...
<html>
	<head>
		...
		<title>Belajar Tajwid - Hukum Mad</title>
	...
	<div class="body">
		...
		<div class="body-m">
		<h2> Kategori : Hukum Mad</h2>
	<?php
	$sql = "select *from hukumtajwid where tingkat=2 order by id limit 1";
	...
	endforeach;
	?>
	<h3 style="color:#999999;">Macam - Macam Mad Far'i</h3><br>
	<?php
