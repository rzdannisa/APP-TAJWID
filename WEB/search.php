...
<html>
	<head>
		...
		<title>Belajar Tajwid - Search</title>
	...
	<div class="body">
		<div class="logo"><img src="css/bt.jpg"></div>
			<div class="header">
				...
				<li><a href="tajwidt3.php">Hukum Mim Mati <i class="fa fa-chevron-down"></i></a>
					<ul>
					<li><a href="http://ariefsetya.com/p3m/atajwidview.php?id=17">Ikhfa Syafawi</a></li>
		...
		<div class="body-m">
		<h2> Hasil Pencarian &quot;<?php echo $_POST['search'];?>&quot;</h2>
		<?php
		$sql = "select *from hukumtajwid where penjelasan like '%".$_POST['search']."%' order by id desc";
		$no=1;
		foreach ($dbh->query($sql) as $data) :
		?>
			<div class="mt2">
				<p><a class="nh" href="view.php?id=<?php echo $data['id']; ?>""><?php echo $data['namahukum'];?></a>
				<img class="gh" src="<?php echo $data['contoh2'];?>"></p><br><br>
