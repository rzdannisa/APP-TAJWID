...
void __fastcall Tmd_lin::abMouseLeave(TObject *Sender)
{
	ab->Color=0x003F3122;
...
void __fastcall Tmd_lin::abMouseMove(TObject *Sender, TShiftState Shift, int X, int Y)
...
void __fastcall Tmd_lin::abClick(TObject *Sender)
{
  if (!mhuruf)
	mhuruf = new Tmhuruf(this);
  mhuruf->Show();
