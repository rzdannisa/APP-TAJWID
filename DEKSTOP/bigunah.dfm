object bgn: Tbgn
  ...
  object Panel4: TPanel
    ...
    object p1: TPanel
      ...
      Cursor = crHandPoint
      BevelOuter = bvNone
      Caption = 'Hukum Tanwin dan Nun  Mati'
      Color = 4141346
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -17
    ...
    object cl: TPanel
      ...
      TabOrder = 3
      OnClick = clClick
      OnMouseLeave = clMouseLeave
      OnMouseMove = clMouseMove
    end
    object ab: TPanel
      Left = 1000
      Top = -2
      ...
      TabOrder = 4
      OnClick = abClick
      OnMouseLeave = abMouseLeave
      OnMouseMove = abMouseMove
    end
  end
  ...
  object OpenDialog1: TOpenDialog
    FileName = 'E:\Etc\When You Believe Mariah Carey No 1'
    Filter = 
      'Mp3(*.mp3)|*.mp3|Dat(*.dat)|*.dat|Mp4(*.mp4)|*.mp4|Mpg(*.mpg)|*.' +
      'mpg|Flv(*.flv)|*.flv|Mkv(*.mkv)|*.mkv|Aw(*.aw)|*.aw'
    Left = 1080
    Top = 120
  end
